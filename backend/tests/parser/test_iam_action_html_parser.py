...
def test_aws_action_list():
    ...
    parser = IAMActionHTMLParser()
    parser.feed(html)
    assert parser.rows == [["AssociateDirectory","Grants permission to connect a directory to be used by AWS IAM Identity Center","Write","","","ds:AuthorizeApplication"],
["AssociateProfile","Grants permission to create an association between a directory user or group and a profile","Write","","",""],
["AttachCustomerManagedPolicyReferenceToPermissionSet","Grants permission to attach a customer managed policy reference to a permission set","Permissions management","Instance*","",""],
["AttachCustomerManagedPolicyReferenceToPermissionSet","Grants permission to attach a customer managed policy reference to a permission set","Permissions management","PermissionSet*","",""],
["AttachManagedPolicyToPermissionSet","Grants permission to attach an AWS managed policy to a permission set","Permissions management","Instance*","",""],
["AttachManagedPolicyToPermissionSet","Grants permission to attach an AWS managed policy to a permission set","Permissions management","PermissionSet*","",""],
["CreateAccountAssignment","Grants permission to assign access to a Principal for a specified AWS account using a specified permission set","Write","Account*","",""],
["CreateAccountAssignment","Grants permission to assign access to a Principal for a specified AWS account using a specified permission set","Write","Instance*","",""],
["CreateAccountAssignment","Grants permission to assign access to a Principal for a specified AWS account using a specified permission set","Write","PermissionSet*","",""],
["CreateApplication","Grants permission to create an application","Write","ApplicationProvider*","",""],
["CreateApplication","Grants permission to create an application","Write","Instance*","",""],
["CreateApplication","Grants permission to create an application","Write","","aws:RequestTag/${TagKey} aws:TagKeys",""],
["CreateApplicationAssignment","Grants permission to create an application assignment","Write","Application*","",""],
["CreateApplication","Grants permission to create an application","Write","","sso:ApplicationAccount",""],
...
["CreateInstance","Grants permission to create an identity center instance","Write","","aws:RequestTag/${TagKey} aws:TagKeys",""],
...
["CreatePermissionSet","Grants permission to create a permission set","Write","Instance*","",""],
["CreatePermissionSet","Grants permission to create a permission set","Write","PermissionSet*","",""],
["CreatePermissionSet","Grants permission to create a permission set","Write","","aws:RequestTag/${TagKey} aws:TagKeys",""],
...
["CreateTrustedTokenIssuer","Grants permission to create a trusted token issuer for an instance","Write","","aws:RequestTag/${TagKey} aws:TagKeys",""],
["DeleteAccountAssignment","Grants permission to delete a Principal's access from a specified AWS account using a specified permission set","Write","Account*","",""],
["DeleteAccountAssignment","Grants permission to delete a Principal's access from a specified AWS account using a specified permission set","Write","Instance*","",""],
["DeleteAccountAssignment","Grants permission to delete a Principal's access from a specified AWS account using a specified permission set","Write","PermissionSet*","",""],
["DeleteApplication","Grants permission to delete an application","Write","Application*","",""],
["DeleteApplication","Grants permission to delete an application","Write","","sso:ApplicationAccount",""],
["DeleteApplicationAccessScope","Grants permission to delete an access scope to an application","Write","Application*","",""],
["DeleteApplicationAccessScope","Grants permission to delete an access scope to an application","Write","","sso:ApplicationAccount",""],
["DeleteApplicationAssignment","Grants permission to delete an application assignment","Write","Application*","",""],
["DeleteApplicationAssignment","Grants permission to delete an application assignment","Write","","sso:ApplicationAccount",""],
...
["DeleteApplicationAuthenticationMethod","Grants permission to delete an authentication method to an application","Write","","sso:ApplicationAccount",""],
["DeleteApplicationGrant","Grants permission to delete a grant from an application","Write","Application*","",""],
["DeleteApplicationGrant","Grants permission to delete a grant from an application","Write","","sso:ApplicationAccount",""],
...
["DeleteInlinePolicyFromPermissionSet","Grants permission to delete the inline policy from a specified permission set","Write","PermissionSet*","",""],
...
["DeletePermissionSet","Grants permission to delete a permission set","Write","Instance*","",""],
["DeletePermissionSet","Grants permission to delete a permission set","Write","PermissionSet*","",""],
["DeletePermissionsBoundaryFromPermissionSet","Grants permission to remove permissions boundary from a permission set","Permissions management","Instance*","",""],
["DeletePermissionsBoundaryFromPermissionSet","Grants permission to remove permissions boundary from a permission set","Permissions management","PermissionSet*","",""],
...
["DescribeApplication","Grants permission to obtain information about an application","Read","Application*","",""],
["DescribeApplication","Grants permission to obtain information about an application","Read","","sso:ApplicationAccount",""],
["DescribeApplicationAssignment","Grants permission to retrieve an application assignment","Read","Application*","",""],
["DescribeApplicationAssignment","Grants permission to retrieve an application assignment","Read","","sso:ApplicationAccount",""],
...
["DescribePermissionSet","Grants permission to describe a permission set","Read","Instance*","",""],
["DescribePermissionSet","Grants permission to describe a permission set","Read","PermissionSet*","",""],
...
["DetachCustomerManagedPolicyReferenceFromPermissionSet","Grants permission to detach a customer managed policy reference from a permission set","Permissions management","Instance*","",""],
["DetachCustomerManagedPolicyReferenceFromPermissionSet","Grants permission to detach a customer managed policy reference from a permission set","Permissions management","PermissionSet*","",""],
["DetachManagedPolicyFromPermissionSet","Grants permission to detach the attached AWS managed policy from the specified permission set","Permissions management","Instance*","",""],
["DetachManagedPolicyFromPermissionSet","Grants permission to detach the attached AWS managed policy from the specified permission set","Permissions management","PermissionSet*","",""],
...
["GetApplicationAccessScope","Grants permission to get an access scope to an application","Read","Application*","",""],
["GetApplicationAccessScope","Grants permission to get an access scope to an application","Read","","sso:ApplicationAccount",""],
["GetApplicationAssignmentConfiguration","Grants permission to read assignment configurations for an application","Read","Application*","",""],
["GetApplicationAssignmentConfiguration","Grants permission to read assignment configurations for an application","Read","","sso:ApplicationAccount",""],
["GetApplicationAuthenticationMethod","Grants permission to get an authentication method to an application","Read","Application*","",""],
["GetApplicationAuthenticationMethod","Grants permission to get an authentication method to an application","Read","","sso:ApplicationAccount",""],
["GetApplicationGrant","Grants permission to obtain details about a grant belonging to an application","Read","Application*","",""],
["GetApplicationGrant","Grants permission to obtain details about a grant belonging to an application","Read","","sso:ApplicationAccount",""],
...
["GetInlinePolicyForPermissionSet","Grants permission to obtain the inline policy assigned to the permission set","Read","Instance*","",""],
["GetInlinePolicyForPermissionSet","Grants permission to obtain the inline policy assigned to the permission set","Read","PermissionSet*","",""],
...
["GetPermissionsBoundaryForPermissionSet","Grants permission to get permissions boundary for a permission set","Read","Instance*","",""],
["GetPermissionsBoundaryForPermissionSet","Grants permission to get permissions boundary for a permission set","Read","PermissionSet*","",""],
...
["ListAccountAssignments","Grants permission to list the assignee of the specified AWS account with the specified permission set","List","Instance*","",""],
["ListAccountAssignments","Grants permission to list the assignee of the specified AWS account with the specified permission set","List","PermissionSet*","",""],
...
["ListAccountsForProvisionedPermissionSet","Grants permission to list all the AWS accounts where the specified permission set is provisioned","List","PermissionSet*","",""],
["ListApplicationAccessScopes","Grants permission to list access scopes to an application","List","Application*","",""],
["ListApplicationAccessScopes","Grants permission to list access scopes to an application","List","","sso:ApplicationAccount",""],
["ListApplicationAssignments","Grants permission to list application assignments","List","Application*","",""],
["ListApplicationAssignments","Grants permission to list application assignments","List","","sso:ApplicationAccount",""],
["ListApplicationAssignmentsForPrincipal","Grants permission to list applications assigned to user or group","List","Instance*","",""],
["ListApplicationAssignmentsForPrincipal","Grants permission to list applications assigned to user or group","List","","sso:ApplicationAccount",""],
["ListApplicationAuthenticationMethods","Grants permission to list authentication methods to an application","List","Application*","",""],
["ListApplicationAuthenticationMethods","Grants permission to list authentication methods to an application","List","","sso:ApplicationAccount",""],
["ListApplicationGrants","Grants permission to list grants from an application","List","Application*","",""],
["ListApplicationGrants","Grants permission to list grants from an application","List","","sso:ApplicationAccount",""],
...
["ListCustomerManagedPolicyReferencesInPermissionSet","Grants permission to list the customer managed policy references that are attached to a permission set","List","Instance*","",""],
["ListCustomerManagedPolicyReferencesInPermissionSet","Grants permission to list the customer managed policy references that are attached to a permission set","List","PermissionSet*","",""],
...
["ListManagedPoliciesInPermissionSet","Grants permission to list the AWS managed policies that are attached to a specified permission set","List","Instance*","",""],
["ListManagedPoliciesInPermissionSet","Grants permission to list the AWS managed policies that are attached to a specified permission set","List","PermissionSet*","",""],
...
["ListPermissionSetsProvisionedToAccount","Grants permission to list all the permission sets that are provisioned to a specified AWS account","List","Account*","",""],
["ListPermissionSetsProvisionedToAccount","Grants permission to list all the permission sets that are provisioned to a specified AWS account","List","Instance*","",""],
...
["ListTagsForResource","Grants permission to list the tags that are attached to a specified resource","Read","Application","",""],
["ListTagsForResource","Grants permission to list the tags that are attached to a specified resource","Read","Instance","",""],
["ListTagsForResource","Grants permission to list the tags that are attached to a specified resource","Read","PermissionSet","",""],
["ListTagsForResource","Grants permission to list the tags that are attached to a specified resource","Read","TrustedTokenIssuer","",""],
...
["ProvisionPermissionSet","Grants permission to provision a specified permission set to the specified target","Write","Instance*","",""],
["ProvisionPermissionSet","Grants permission to provision a specified permission set to the specified target","Write","PermissionSet*","",""],
["PutApplicationAccessScope","Grants permission to create/update an access scope to an application","Write","Application*","",""],
["PutApplicationAccessScope","Grants permission to create/update an access scope to an application","Write","","sso:ApplicationAccount",""],
...
["PutApplicationAssignmentConfiguration","Grants permission to add assignment configurations to an application","Write","","sso:ApplicationAccount",""],
...
["PutApplicationAuthenticationMethod","Grants permission to create/update an authentication method to an application","Write","","sso:ApplicationAccount",""],
["PutApplicationGrant","Grants permission to create/update a grant to an application","Write","Application*","",""],
["PutApplicationGrant","Grants permission to create/update a grant to an application","Write","","sso:ApplicationAccount",""],
["PutInlinePolicyToPermissionSet","Grants permission to attach an IAM inline policy to a permission set","Write","Instance*","",""],
["PutInlinePolicyToPermissionSet","Grants permission to attach an IAM inline policy to a permission set","Write","PermissionSet*","",""],
...
["PutPermissionsBoundaryToPermissionSet","Grants permission to add permissions boundary to a permission set","Permissions management","PermissionSet*","",""],
...
["TagResource","Grants permission to associate a set of tags with a specified resource","Tagging","Instance","",""],
["TagResource","Grants permission to associate a set of tags with a specified resource","Tagging","PermissionSet","",""],
["TagResource","Grants permission to associate a set of tags with a specified resource","Tagging","TrustedTokenIssuer","",""],
["TagResource","Grants permission to associate a set of tags with a specified resource","Tagging","","aws:RequestTag/${TagKey} aws:TagKeys",""],
["UntagResource","Grants permission to disassociate a set of tags from a specified resource","Tagging","Application","",""],
["UntagResource","Grants permission to disassociate a set of tags from a specified resource","Tagging","Instance","",""],
["UntagResource","Grants permission to disassociate a set of tags from a specified resource","Tagging","PermissionSet","",""],
["UntagResource","Grants permission to disassociate a set of tags from a specified resource","Tagging","TrustedTokenIssuer","",""],
["UntagResource","Grants permission to disassociate a set of tags from a specified resource","Tagging","","aws:TagKeys",""],
["UpdateApplication","Grants permission to update an application","Write","Application*","",""],
["UpdateApplication","Grants permission to update an application","Write","","sso:ApplicationAccount",""],
...
["UpdatePermissionSet","Grants permission to update the permission set","Permissions management","Instance*","",""],
["UpdatePermissionSet","Grants permission to update the permission set","Permissions management","PermissionSet*","",""],
